...
<div class="flex flex-col justify-center items-center">
    ...
    <div class="flex justify-center m-12 p-6 lg:p-8">
        <div class="flex">
            <div class="flex flex-wrap justify-center mt-5 gap-4 sm:gap-8">
                <div class="w-full max-w-[350px] h-auto sm:w-[300px] sm:h-[180px] md:w-[350px] md:h-[200px] 
            scale-100 p-6 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 
            via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl 
            shadow-gray-500/20 dark:shadow-none motion-safe:hover:scale-[1.03] transition-all 
            duration-250 focus:outline focus:outline-2 focus:outline-red-500 mx-auto">
                    <a href="{{ url(app()->getLocale() . '/projects') }}">
                        <div class="flex flex-col">
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor"
                                class="bi bi-book dark:text-white" viewBox="0 0 16 16">
                                <path
            ...
            duration-250 focus:outline focus:outline-2 focus:outline-red-500 mx-auto">
                    <a href="{{ url(app()->getLocale() . '/about') }}">
                        <div class="flex flex-col">
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor"
                                class="bi bi-three-dots dark:text-white" viewBox="0 0 16 16">
                                <path
            ...
            duration-250 focus:outline focus:outline-2 focus:outline-red-500 mx-auto">
                    <a href="{{ url(app()->getLocale() . '/skills') }}">
                        <div class="flex flex-col">
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor"
                                class="bi bi-boxes dark:text-white" viewBox="0 0 16 16">
                                <path
            ...
            duration-250 focus:outline focus:outline-2 focus:outline-red-500 mx-auto">
                    <a href="{{ url(app()->getLocale() . '/contact') }}">
                        <div class="flex flex-col">
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor"
                                class="bi bi-envelope dark:text-white" viewBox="0 0 16 16">
                                <path
