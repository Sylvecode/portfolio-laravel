    ...
    <div class="flex justify-center m-50 p-6 lg:p-8">
        ...
        <div class="mt-16 flex sm:flex sm:justify-center">
            <div class="flex gap-8">
                <div
                    class="w-[350px] h-[200px] scale-100 p-6 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none flex motion-safe:hover:scale-[1.03] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                    <a href="{{ url(app()->getLocale() . '/projects') }}">
                        <div>
                            ...
                            <h2 class="flex justify-center mt-6 text-xl font-semibold text-gray-900 dark:text-white">
                                {{__('my projects')}}
                            </h2>
                        ...
                        <div class="flex justify-end">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                class="shrink-0 stroke-red-500 w-6 h-6 mx-6">
