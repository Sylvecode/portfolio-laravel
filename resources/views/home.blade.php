...
<div class="flex sm:flex sm:justify-center sm:items-center  flex-col">
    <div class=" p-6 lg:p-8">
        <div class="flex justify-center">
            <img src="{{ asset('images/profile_pic_sylvain.webp') }}" class="imgSylv rounded-full border-10 border-white"
            ...
            <div class="flex gap-8">
                <a href="{{ url(app()->getLocale() . '/projects') }}"
                    ...
                    <div>
                        ...
                        <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">{{__('my projects')}}</h2>
                ...
                <a href="{{ url(app()->getLocale() . '/about') }}"
                    ...
                    <div>
                        ...
                        <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">{{__('about')}}</h2>
                ...
                <a href="{{ url(app()->getLocale() . '/skills') }}"
                    ...
                    <div>
                        ...
                        <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">{{__('skills')}}</h2>
                ...
                <a href="{{ url(app()->getLocale() . '/contact') }}"
                    ...
                    <div>
                        ...
                        <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">{{__('contact')}}</h2>
